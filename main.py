...
class VoxelEngine:
    ...
    def update(self):
        ...
        pg.display.set_caption(f'FPS: {self.clock.get_fps() :.0f},  POS: {self.player.position}, {glm.ivec3(self.player.position)}, {self.scene.world.voxel_handler.is_solid(self.player.position)}')
